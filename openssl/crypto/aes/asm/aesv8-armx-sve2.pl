...
sub emit_xts_func {
    ...
    my $sve2_name = "${prefix}_${bits}_${direction}";
...
emit_xts_func(192, "encrypt", "aese", "aesmc", 12);
emit_xts_func(192, "decrypt", "aesd", "aesimc", 12);
